    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.unsplash.com/photo-1550376026-33cbee34f79e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
              Sustainable Electronics for a Better and Greener Future
            </h1>
            <p className="text-lg md:text-xl mb-8 text-muted-foreground">
            "Transform E-Waste into Innovation! ♻️⚡ Discover high-quality refurbished electronic components and build a greener, smarter future with us! 🌍✨"
            </p>
            <button 
              onClick={() => router.push('/products')}
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-full font-semibold flex items-center gap-2 mx-auto transition-all"
            >
              Explore Components
